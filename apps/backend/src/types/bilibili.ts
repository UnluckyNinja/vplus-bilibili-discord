...
export type DynamicInfoBase = {
  id_str: string;
  url: string;
  /**
   * Unix time, needs x1000 when using with date
   */
  timestamp: number;
  author: {
    name: string;
...
export type DynamicInfo = DynamicInfoBase & DynamicInfoType;
